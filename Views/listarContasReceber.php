                ...
                <table  id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        	 if (isset($viewData['contasReceber']))
                        		{ 
                        			foreach ($viewData['contasReceber'] as $key) { ?>
	                        			<tr>
                                            ...
                                            <td class="center">
		        	                   			<a class="green" href="<?php echo BASE_URL."ContasReceber/Editar/".$key['id'];  ?>">
													<i class="ace-icon fa fa-pencil bigger-130 odd gradeX" data-toggle="tooltip" data-placement="top" title="Editar"></i>
												</a>
                                                <?php if ($key['origem'] == 0) {?>
												<a class="red" href="<?php echo BASE_URL."ContasReceber/Remover/".$key['id'];  ?>">
