...
<form action="" method="POST" class="form-horizontal" role="form">
	<div class="form-group">
        ...
        <div class="col-sm-2">
        	<input class="form-control" type="text" name="codigo" placeholder="Razão Social ME LTDA EIRELI" value="<?php echo $viewData['grupodeprodutos']['id']; ?>" disabled>
        </div>
    ...
    <div class="form-group">
       	...
       	<div class="col-sm-9">
           	<input class="form-control" type="text" name="grupo" placeholder="Nome da Pessoa" value="<?php echo $viewData['grupodeprodutos']['grupo']; ?>" requerid>
       	</div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
              ...
              <option value="ANALITICO" <?php echo ($viewData['grupodeprodutos']['tipo'] == "ANALITICO")?'selected="selected"':''; ?>>ANALITICO</option>
              <option value="SINTETICO" <?php echo ($viewData['grupodeprodutos']['tipo'] == "SINTETICO")?'selected="selected"':''; ?>>SINTETICO</option>
           	</select>
		</div>
    </div>
